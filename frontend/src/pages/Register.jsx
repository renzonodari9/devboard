    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#a3a3a3] text-lg">Crea tu cuenta</p>
        </div>
        ...
        <div className="bg-[#171717] border border-[#262626] rounded-2xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm text-[#a3a3a3] mb-2 font-medium">Nombre</label>
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-[#525252]" size={18} />
                <input
                  type="text"
                  value={name}
